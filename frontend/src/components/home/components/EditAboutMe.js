        ...
        <>
            ...
            <div className="flex max-md:flex-col my-4 items-center">
                ...
                <div className="w-1/6 max-md:w-full max-md:mt-4 max-md:flex max-md:flex-col max-md:items-center text-lg">
                    <a className="flex hover:opacity-80 w-fit max-md:text-sm" href={`mailto:${formData.mail}`} target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="max-md:flex max-md:justify-evenly max-md:gap-4 max-md:mt-1">
                        <a className="flex hover:opacity-80 w-fit max-md:text-sm" href={formData.github_url} target="_blank" rel="noopener noreferrer">
