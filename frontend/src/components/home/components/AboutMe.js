                    ...
                    {aboutMe && (
                        <>
                            ...
                            <div className="flex max-md:flex-col my-4 items-center">
                                <div className="w-4/5 mr-8 max-md:mr-0 max-md:w-full max-md:text-sm">
                                    <div className="flex justify-between items-start mb-4 max-sm:flex-col">
                                        <div className="w-3/4 max-sm:w-full max-sm:mb-2">
                                            <h4 className="-ml-2">経歴</h4>
                                            <div dangerouslySetInnerHTML={markedText(aboutMe[0].history)} />
                                        </div>
                                        <div className="w-1/4 max-sm:w-full">
                                            <h4 className="-ml-2">スキル</h4>
                                            <div dangerouslySetInnerHTML={markedText(aboutMe[0].skill)} />
                                        </div>
                                    </div>
                                    <div dangerouslySetInnerHTML={markedText(aboutMe[0].introduction)} />
                                </div>
                                <div className="w-1/5 max-md:w-full max-md:mt-4 max-md:flex max-md:flex-col max-md:items-center text-lg">
